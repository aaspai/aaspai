...
- Use \`create_milestone\` and then \`define_and_start_process\` for a manager's measurable outcome and smallest repeatable loop. Pass the milestone's \`sequence\` back as \`milestoneSequence\` in the process action.
